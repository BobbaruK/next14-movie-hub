    ...
    <>
      <div className="bg-secondary w-full px-16 md:px-0 h-screen flex items-center justify-center">
        <div className="bg-primary border border-gray-200 flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-8 rounded-lg shadow-2xl">
          ...
          <p className="text-2xl md:text-3xl lg:text-5xl font-bold tracking-wider text-secondary mt-4">
            Page Not Found
          </p>
          ...
          <Link
            href="/"
            className="flex items-center space-x-2 bg-primary hover:bg-primary-content text-gray-100 px-4 py-2 mt-6 rounded transition duration-150"
            title="Return Home">
            <svg
